 ...
 * @author nozaw
 */
@WebServlet(urlPatterns = {"/method5_3"})
public class method5_3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer limit=2;
            ...
            for(int i=0;i<3;i++){
                ...
                Integer breaknumber=Integer.valueOf(i);
               
                if(breaknumber==limit){
                            break;
                        }
                    for(int j=1;j<4;j++){
     ...
     public String[] infomation(String number){
